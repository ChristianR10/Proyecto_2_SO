...
public class Procesador extends Thread {
            ...
            if (isTurno() == true) {
                try {
                    ...
                    if (getAviso2() != 0) {
                        ...
                        Pantalla.labelCreation(getzFigther(), Pantalla.SWPanel4);
                        Pantalla.getStRefuerzo().encolar(this.getStFigther());
                        Pantalla.labelCreation(getStFigther(), Pantalla.STPanel4);
                        this.setAviso2(0);
                    }

                    Pantalla.contVictoriasSW.setText(Integer.toString(Pantalla.SWWins));
    ...
    public void insertarPeleadores() {
        try {
            this.setzFigther(Pantalla.SWFigther);
    ...
    public void empate() {
        try {
            ...
            Pantalla.labelCreation(getzFigther(), Pantalla.SWPanelP1);
